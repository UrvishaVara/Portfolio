  ...
  return (
    <div className='flex justify-between items-start gap-12 text-white p-12 '>
      <div className='bg-gray-700 min-w-96 bg-opacity-25 p-6 rounded-3xl shadow-md shadow-white/30'>
        ...
        <h2 className="text-2xl text-center font-semibold mt-4">Urvisha Vara</h2>
        <p className="text-gray-400 text-center">I am a Full-Stack devloper based in INDIA.</p>
        <div className="flex justify-center gap-4 mt-3 py-2 items-center">
      ...
      <div className='flex flex-col gap-7'>
        ...
        <div className='flex gap-8 justify-center items-center bg-gray-700 bg-opacity-25 p-10 min-h-40 rounded-3xl shadow-md shadow-white/30'>
          <div>HTML</div>
          <div>CSS</div>
          <div>BOOTSTRAP</div>
          <div>JAVASCRIPT</div>
